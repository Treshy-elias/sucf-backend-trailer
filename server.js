...
app.use(cors({
    origin: ["https://sucf-frontend-tralier.vercel.app", "http://192.168.80.59:5173", "http://localhost:5173", "http://localhost:5174/user-detail"], // Ensure the correct frontend URL
